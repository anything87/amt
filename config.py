...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5384534267:AAFCD8IrJGTIEtzpDoUUbMapertLGXfV6FI") # Bot token from @BotFather
ADMINS = [int(i.strip()) for i in os.environ.get("ADMINS", "5543917190").split(",")] if os.environ.get("ADMINS", "5543917190") else []

DATABASE_NAME = os.environ.get("DATABASE_NAME", "Cluster0")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://babu:babu@cluster0.q3l9nbe.mongodb.net/?retryWrites=true&w=majority") # mongodb uri from https://www.mongodb.com/
OWNER_ID =  int(os.environ.get("OWNER_ID", "5543917190")) # id of the owner
ADMINS.append(OWNER_ID) if OWNER_ID not in ADMINS else []

#  Optionnal variables
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001734771621")) # log channel for information about users
