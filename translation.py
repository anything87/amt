...
(See Example.👇)
Example:** `/set_api 2468d18b4c3bfdf254bd96a816a079b9cd5e46cf`
...
If You Have Any Problem Then Contact - @AM_ROBOTSS
...
`📢 Support:` [DK BOTZ SUPPORT](https://amrobots.online)
...
METHOD_REPLY_MARKUP = InlineKeyboardMarkup([
    [
        InlineKeyboardButton('Mdisk + Shortener', callback_data=f'change_method#amrobotsWithMdisk'),
...
Ex: `/set_api 2468d18b4c3bfdf254bd96a816a079b9cd5e46cf`
